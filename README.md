...
## What's live — 22 categories, 460+ tools, ~559 pages
...
| [Chemistry & Lab](https://lazytools.io/chemistry/) | **19 tools** — **molar mass / molecular weight** (parses hydrates like CuSO₄·5H₂O + nested groups) with percent composition, **chemical equation balancer** (exact integer coefficients via BigInt null-space — correct on redox), **stoichiometry** (limiting reagent + theoretical yield), **empirical/molecular formula**, **mole ↔ grams ↔ particles**, **molarity**, **dilution** (C₁V₁=C₂V₂), **percent yield**, **density**, **ideal gas / combined gas law**, **specific heat**, **pH**, **Henderson–Hasselbalch**, **Beer–Lambert**, **half-life** |
...
Plus **65 in-depth guides** on the [blog](https://lazytools.io/blog/) — each with custom infographics,
...
npm run build    # static site → dist/ (~559 pages)
```
