...
## What's live — 40 categories, 900+ tools, ~1,060 pages
...
| [Charts & Design](https://lazytools.io/charts/) | **3 chart makers** — **bar chart maker**, **line chart maker**, **pie & donut chart maker** — paste “label, value” lines, pick a palette, download a crisp 2× **PNG** or an editable **SVG**; drawn with SVG in your browser (auto percentages + legend for pie), nothing uploaded |
