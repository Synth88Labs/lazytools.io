...
| [Developer Tools](https://lazytools.io/dev/) | Base64, hashes, JWT, regex, number-base, **query-string parser** (↔ JSON), **HTTP status code lookup**, **LLM token counter (exact o200k)**, **Ethereum unit converter** (BigInt-exact wei⇄ether), **Keccak-256/SHA-3 + function selector**, **EIP-55 address checksum**, **JSON string escaper/unescaper**, **Unicode escape converter** (\uXXXX ↔ text) |
