...
## What's live — 21 categories, 420+ tools, ~516 pages
...
Plus **60 in-depth guides** on the [blog](https://lazytools.io/blog/) — each with custom infographics,
...
npm run build    # static site → dist/ (~516 pages)
```
