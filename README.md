...
| [Homebrewing](https://lazytools.io/brewing/) | **10 tools** — **ABV** ((OG−FG)×131.25 + Hall's accurate formula, attenuation, calories), **IBU** (Tinseth model, editable hop-additions table), **priming sugar** (CO₂ stoichiometry, bottle carbonation), **Brix↔SG**, **hydrometer temperature correction**, **strike water** (Palmer, metric/imperial), **gravity dilution**, **refractometer FG** (Sean Terrill cubic + WCF) — established brewing formulas verified vs Palmer/Tinseth/Terrill, Node-tested |
