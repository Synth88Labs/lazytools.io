...
## What's live — 40 categories, 900+ tools, ~1,070 pages
...
| [Calculators](https://lazytools.io/calc/) | **27 tools** — percentage, EMI, BMI, age, tip, discount, interest, mortgage, sales tax, fuel cost, GPA, **test grade (EZ grader)**, **unit price**, **overtime pay**, **square footage**, **cost per square foot**, **dilution ratio (1:N mixing)**… |
...
Plus **115 in-depth guides** on the [blog](https://lazytools.io/blog/) — each with custom infographics,
