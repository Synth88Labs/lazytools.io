...
## What's live — 41 categories, 930+ tools, ~1,100 pages
...
| [Fonts & Typography](https://lazytools.io/fonts/) | **19 tools** — **fancy font & text generator** (21 Unicode styles: 𝗯𝗼𝗹𝗱, 𝘪𝘵𝘢𝘭𝘪𝘤, 𝓼𝓬𝓻𝓲𝓹𝓽, 𝔣𝔯𝔞𝔨𝔱𝔲𝔯, 𝕕𝕠𝕦𝕓𝕝𝕖-𝕤𝕥𝕣𝕦𝕔𝕜, ᴍᴀʟʟ ᴄᴀᴘꜱ, ⓑⓤⓑⓑⓛⓔ, ｗｉｄｅ, s̶t̶r̶i̶k̶e̶ — real Unicode you can paste into Instagram/TikTok/X bios, gaps patched from Letterlike Symbols so no blank boxes), plus focused **bold**, **italic**, **cursive**, **small-caps**, **bubble**, **wide**, **strikethrough**, **superscript/subscript** & **emoji-letter** generators — a **glitch/Zalgo (cursed text)** generator with a madness slider, an **invisible / blank name** generator (Free Fire, WhatsApp, Discord), a **symbols & special-characters** copy-paste picker (arrows, stars, hearts, math…), a **Discord colored-text (ANSI)** generator and a **text repeater** — and for CSS: **px↔rem converter**, **modular type-scale generator** (golden ratio + 7 more → copy-paste custom properties), **line-height calculator** (comfortable-reading bands), **clamp() fluid-typography generator** — all client-side, nothing uploaded |
