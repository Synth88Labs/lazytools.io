...
## What's live — 41 categories, 920+ tools, ~1,090 pages
...
| [Fonts & Typography](https://lazytools.io/fonts/) | **11 tools** — **fancy font & text generator** (17 Unicode styles: 𝗯𝗼𝗹𝗱, 𝘪𝘵𝘢𝘭𝘪𝘤, 𝓼𝓬𝓻𝓲𝓹𝓽, 𝔣𝔯𝔞𝔨𝔱𝔲𝔯, 𝕕𝕠𝕦𝕓𝕝𝕖-𝕤𝕥𝕣𝕦𝕔𝕜, ᴍᴀʟʟ ᴄᴀᴘꜱ, ⓑⓤⓑⓑⓛⓔ, ｗｉｄｅ, s̶t̶r̶i̶k̶e̶ — real Unicode you can paste into Instagram/TikTok/X bios, gaps patched from Letterlike Symbols so no blank boxes), plus focused **bold**, **italic**, **cursive**, **small-caps**, **bubble**, **wide** & **strikethrough** generators — and for CSS: **px↔rem converter**, **modular type-scale generator** (golden ratio + 7 more → copy-paste custom properties), **line-height calculator** (comfortable-reading bands) — all client-side, nothing uploaded |
