...
| [Charts & Design](https://lazytools.io/charts/) | **6 chart makers** — **bar**, **line**, **pie & donut**, **funnel** (conversion stages + %), **radar/spider** (multi-axis profile), **waterfall** (running total, +/- floating bars) — paste “label, value” lines, pick a palette, download a crisp 2× **PNG** or an editable **SVG**; drawn with SVG in your browser, nothing uploaded |
