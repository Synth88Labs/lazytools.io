...
const POSTS = [
  ...
  },
  {
    ...
    lines: ['How to calculate', 'your GPA the', 'right way'],
    fact: 'GPA = Σ(grade points × credits) ÷ Σ credits · A=4.0 B=3.0',
    icon: '🎓',
  },
  {
    slug: 'bmi-calculator-guide',
    kicker: 'HEALTH GUIDE',
    lines: ['How to calculate', 'BMI — and what', 'it actually means'],
    fact: 'BMI = weight(kg) ÷ height(m)² · normal 18.5–24.9 (WHO)',
    icon: '🩺',
  },
  {
    slug: 'oven-to-air-fryer-conversion-guide',
    kicker: 'COOKING GUIDE',
    lines: ['Oven to air fryer:', 'the −25°F,', '−20% rule'],
    fact: '400°F for 30 min → about 375°F for 24 min',
    icon: '🍟',
  },
  {
    slug: 'what-size-air-conditioner-guide',
    kicker: 'HOME & DIY GUIDE',
    lines: ['What size air', 'conditioner do', 'I need?'],
    fact: '≈ 20 BTU/h per ft² · 300 ft² room → ~6,000 BTU',
    icon: '❄️',
  },
  {
    slug: 'hourly-to-salary-guide',
    kicker: 'MONEY GUIDE',
    lines: ['Hourly to salary:', 'what your wage', 'is per year'],
    fact: '$25/hr × 40 h × 52 = $52,000 · shortcut ≈ hourly × 2,000',
    icon: '💼',
  },
  {
    slug: 'rice-to-water-ratio-guide',
    kicker: 'COOKING GUIDE',
    lines: ['Rice to water', 'ratio: perfect', 'rice by type'],
    fact: 'white 2:1 · brown 2.5:1 · basmati 1.5:1 · sushi 1.25:1',
    icon: '🍚',
  },
  {
    slug: 'how-much-soil-for-raised-bed-guide',
    kicker: 'GARDEN GUIDE',
    lines: ['How much soil', 'for a raised', 'bed?'],
    fact: '8 × 4 ft bed, 12 in deep = 32 ft³ ≈ 906 L ≈ 1.2 yd³',
    icon: '🪴',
  },
  {
    slug: 'one-rep-max-calculator-guide',
    kicker: 'FITNESS GUIDE',
    lines: ['Calculate your', 'one-rep max', 'without testing it'],
    fact: 'Epley: 1RM = weight × (1 + reps ÷ 30) · 100kg × 5 ≈ 117kg',
    icon: '🏋️',
  },
  {
    slug: 'calories-burned-calculator-guide',
    kicker: 'FITNESS GUIDE',
    lines: ['How many', 'calories did', 'I burn?'],
    fact: 'cal/min = MET × 3.5 × weight(kg) ÷ 200 (ACSM)',
    icon: '🔥',
  },
  {
    slug: 'flooring-calculator-guide',
    kicker: 'HOME & DIY GUIDE',
    lines: ['How many boxes', 'of flooring', 'do I need?'],
