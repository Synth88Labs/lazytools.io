...
export const TRAVEL_TOOLS: TravelToolDef[] = [
  ...
  },
  {
    ...
    how: 'Driving time is the distance divided by your average speed; add the total time you\'ll spend stopped, fuel, food, rest, for the full trip time. Give a departure time and the tool projects your arrival, rolling over past midnight if the drive is long. It works in kilometres or miles, matching the speed unit you choose. Worked example: 540 km at a realistic 90 km/h average is 540 ÷ 90 = 6 hours of driving; add two 20-minute breaks (40 minutes) for 6 hours 40 minutes total, so a 9:00 departure arrives about 15:40. The single biggest source of error is the average speed, a figure well below the limit, since it must absorb every slowdown and stop.',
    ...
    faqs: [
      ...
      { q: 'How do I estimate arrival time for a long drive?', a: 'Add the total trip time, driving plus all your breaks, to the departure time. For a drive that runs past midnight, the tool marks the arrival "+1 day" so an overnight trip reads correctly rather than wrapping to the wrong date.' },
      { q: 'How often should I take breaks on a road trip?', a: 'A common safety guideline is a rest of at least 15 minutes every two hours of driving, and avoiding driving at the times you would normally be asleep. Add up that break time and enter it here; it is part of the total trip time even though you are not moving.' },
    ],
  ...
  },
  {
    ...
    how: 'The tool divides your total budget by the number of days to give a daily figure, and by travellers for the per-person share, so you can sanity-check a trip before booking. It then splits the daily amount across the usual categories, accommodation, food, local transport, activities and extras, as a starting point you can adjust. Worked example: a 3,000 budget for a 10-day trip for 2 people is 300 per day and 1,500 per person; splitting the daily 300 by a typical shape gives roughly 105 for accommodation, 75 for food, and the rest across transport, activities and extras. The split is only a template, a self-catering week and a restaurant-heavy city break spend the same total very differently.',
    ...
    faqs: [
      ...
      { q: 'How do I split a travel budget by category?', a: 'Apply percentage shares to the daily figure. A common starting split is about 35% accommodation, 25% food, and the remaining 40% across local transport, activities and shopping, then adjust for your trip. The tool suggests a split from your total for you to tweak.' },
      { q: 'Should I budget per day or for the whole trip?', a: 'Both help. A per-day figure is easy to check against real prices at your destination and keeps daily spending in view, while the whole-trip total including flights and a 10-15% contingency tells you what the holiday actually costs. The calculator shows per-day, per-person and total from a single number.' },
    ],
  ...
  },
  {
    ...
    how: 'Travel maths rests on one identity: distance = average speed × time. Rearranged, time = distance ÷ speed and speed = distance ÷ time. Pick which quantity to solve for, enter the other two, and the tool returns the answer, travel time is also shown in hours and minutes. Keep the units consistent (kilometres with km/h, or miles with mph); the toggle sets both together. Worked example: to solve for speed, a 240 km drive that took 3 hours 20 minutes (3.333 hours) averages 240 ÷ 3.333 ≈ 72 km/h. To solve for distance, 50 mph held for 2.5 hours covers 50 × 2.5 = 125 miles. The one thing that trips people up is entering time as a decimal, 90 minutes is 1.5 hours, not 1.30.',
    ...
    faqs: [
      ...
      { q: 'How do I enter minutes as a decimal?', a: 'Divide the minutes by 60 and add them to the hours: 30 minutes is 30 ÷ 60 = 0.5, so 2 hours 30 minutes is 2.5. Common values are 15 min = 0.25, 20 min = 0.333, 45 min = 0.75. Using 2.30 for two-and-a-half hours is the most common mistake.' },
      { q: 'What is the difference between average and instantaneous speed?', a: 'Average speed is the total distance divided by the total time, including every stop and slow section, and it is what this calculator uses. Instantaneous speed is what the speedometer shows at one moment. A trip can average 60 km/h while briefly touching 120, which is why the average is always lower than your cruising speed.' },
    ],
