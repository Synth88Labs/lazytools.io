...
export const PRICES_VERIFIED = '2026-07-28';
...
export const MODEL_PRICES: ModelPrice[] = [
  { id: 'gpt-5.6-sol', name: 'GPT-5.6 Sol', vendor: 'OpenAI', input: 5, output: 30, tokenizer: 'o200k' },
  { id: 'gpt-5.6-terra', name: 'GPT-5.6 Terra', vendor: 'OpenAI', input: 2.5, output: 15, tokenizer: 'o200k' },
  { id: 'gpt-5.6-luna', name: 'GPT-5.6 Luna', vendor: 'OpenAI', input: 1, output: 6, tokenizer: 'o200k' },
