...
export const CHEM_TOOLS: ChemToolDef[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Is molecular weight different from molar mass in practice?', a: 'Not numerically, both equal the same summed atomic-weight total. “Molecular weight” is common in biology and older texts; “molar mass” is the SI-consistent term with units of g/mol. This tool reports g/mol.' },
      { q: 'Does it work for ionic compounds with no molecules?', a: 'Yes. Strictly, salts like NaCl form lattices rather than discrete molecules, so the value is a “formula weight”, but it is computed the same way, summing the atomic weights in the formula unit (NaCl = 58.44 g/mol).' },
      { q: 'How do I find the molecular weight of a hydrate?', a: 'Include the waters of crystallisation. For CuSO₄·5H₂O, add the anhydrous CuSO₄ (159.61) to five waters (5 × 18.015 = 90.07), giving 249.68 g/mol. Write the dot as ·, . or * and the tool adds them.' },
      { q: 'Does molecular weight tell me how heavy one molecule is in grams?', a: 'Not directly. It is the mass of one mole (6.022×10²³ molecules) in grams. Divide the molecular weight by Avogadro’s number for one molecule’s mass: water is 18.015 ÷ 6.022×10²³ ≈ 2.99×10⁻²³ g.' },
    ],
  ...
  },
  {
    ...
    how: 'The molar mass is computed by parsing the formula and summing atomic weights; each element’s total mass (atomic weight × count) is then divided by the molar mass and expressed as a percentage. The percentages sum to 100%. As a worked case, in CO₂ the carbon fraction is 12.011 ÷ 44.009 = 27.29% and oxygen is 72.71%; because it is a ratio of masses, the result is the same whatever amount of sample you have.',
    ...
    faqs: [
      ...
      { q: 'Can I get the mass of one element from a sample?', a: 'Yes, multiply the sample mass by that element’s percent composition. 50 g of CaCO₃ (40.04% Ca) contains 50 × 0.4004 = 20.0 g of calcium.' },
      { q: 'Why might my percentages differ slightly from a textbook?', a: 'Rounding of atomic weights. Using more decimals (O = 15.999 rather than 16) shifts a percentage by a few hundredths. This tool uses full standard atomic weights, so values are as exact as the constants allow.' },
      { q: 'How is percent composition used to check a fertiliser’s nutrient content?', a: 'The mass percent of an element equals the nutrient it supplies. Ammonium nitrate (NH₄NO₃) is 35.0% nitrogen by mass, so 100 kg supplies 35 kg of nitrogen, the basis for comparing fertilisers.' },
      { q: 'Is percent composition the same as percent yield?', a: 'No. Percent composition is the mass fraction of each element within a compound’s formula. Percent yield compares the product you actually made to the theoretical maximum of a reaction. They answer different questions.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'What is the balanced form of Fe + O₂ → Fe₂O₃?', a: 'Solving the atom balances gives 4 Fe + 3 O₂ → 2 Fe₂O₃, four iron and six oxygen atoms on each side. Enter it as “Fe + O2 -> Fe2O3” and the tool returns 4, 3, 2.' },
      { q: 'Does it balance charge for ionic half-reactions?', a: 'This tool balances atoms for full molecular equations. For ionic half-reactions you also balance charge with electrons; enter the complete equation with all species so the atom counts reconcile.' },
    ],
  ...
  },
  {
    ...
    how: 'The ideal gas law relates pressure (P), volume (V), amount (n) and temperature (T): PV = nRT, with R = 0.082057 L·atm·K⁻¹·mol⁻¹. Enter any three quantities in the matching units (atm, L, mol, K) and the tool rearranges the equation to solve for the fourth: P = nRT/V, V = nRT/P, n = PV/RT and T = PV/nR. As a check, one mole of gas at 273.15 K and 1 atm occupies 22.41 L, the familiar molar volume at STP.',
    ...
    faqs: [
      ...
      { q: 'What volume does one mole of gas occupy at STP?', a: 'About 22.4 L at 0 °C (273.15 K) and 1 atm: V = nRT/P = 1 × 0.082057 × 273.15 ÷ 1 = 22.41 L. This molar volume is a handy sanity check.' },
      { q: 'Can I use different pressure or volume units?', a: 'Only if you switch R to match. With R = 0.082057 L·atm/(mol·K) you must use atm and litres; for kPa and litres use R = 8.314, and for mmHg R = 62.36. This tool is set up for atm, L, mol and K.' },
      { q: 'How do I find the density or molar mass of a gas from PV = nRT?', a: 'Substitute n = mass ÷ molar mass to get PV = (mass/M)RT, which rearranges to M = (mass·R·T) ÷ (P·V) and density = PM ÷ RT. So measuring pressure, temperature and a gas’s density gives its molar mass.' },
      { q: 'What is the difference between the ideal gas law and the combined gas law?', a: 'The ideal gas law PV = nRT relates all four state variables at one condition and includes the amount of gas (n). The combined gas law links an initial and final state of a fixed amount of gas, so n cancels and R is not needed.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How much energy heats a cup of water?', a: 'For 250 g of water raised from 20 °C to 100 °C (ΔT = 80 °C): q = 250 × 4.184 × 80 = 83,680 J ≈ 83.7 kJ. Enter the mass, 4.184 for c, and 80 for ΔT.' },
      { q: 'Why does water need so much energy to heat?', a: 'Water has an unusually high specific heat (4.184 J/g·°C) because of extensive hydrogen bonding. Metals are far lower, copper is about 0.385, so the same energy warms copper roughly ten times as much per gram.' },
      { q: 'What is the difference between specific heat and heat capacity?', a: 'Specific heat (c) is per gram, the energy to raise 1 g by 1 °C. Heat capacity is for the whole object: C = m·c. A large pot has a big heat capacity even though its metal’s specific heat is small.' },
      { q: 'Does q = mcΔT cover melting or boiling?', a: 'No. It only applies while a substance stays in one phase and its temperature changes. During a phase change the temperature holds steady, and you use the latent heat (q = m·L) instead.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How much more acidic is pH 3 than pH 5?', a: 'Because pH is a base-10 logarithm, each unit is a factor of ten. pH 3 has [H⁺] = 10⁻³ and pH 5 has 10⁻⁵, so pH 3 is 100 times more acidic.' },
      { q: 'How do I get [H⁺] back from a pH?', a: 'Take the antilog: [H⁺] = 10^(−pH). For pH 8.4, [H⁺] = 10⁻⁸·⁴ ≈ 4.0×10⁻⁹ M. Enter the pH and the tool returns [H⁺] and [OH⁻] automatically.' },
      { q: 'What is the pH of a strong acid like 0.01 M HCl?', a: 'A strong acid ionises completely, so [H⁺] equals the concentration: pH = −log(0.01) = 2. For weak acids that ionise only partially, use the weak-acid pH tool instead.' },
      { q: 'Can pH be negative or above 14?', a: 'Yes, the 0-14 range is just the common span in dilute water. A concentrated strong acid (say 10 M H⁺) gives a negative pH, and a very concentrated base can exceed 14. The −log relationship still holds.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Does adding more solvent change the molality?', a: 'Yes, molality is moles of solute per kilogram of solvent, so doubling the solvent halves the molality. Unlike molarity, though, it never changes with temperature, because mass does not expand.' },
      { q: 'How do I convert molarity to molality?', a: 'You need the solution’s density: molality = molarity ÷ (density − molarity × molar mass of solute ÷ 1000). For dilute aqueous solutions the two values are nearly equal.' },
  ...
  },
  {
    ...
    how: 'Mass percent by weight is %(w/w) = mass of solute ÷ mass of solution × 100, where the solution\'s mass is the solute plus the solvent. The tool adds your two masses to get the solution mass and computes the percentage. Any consistent mass unit works, grams in, grams out, since the units cancel in the ratio. Rearranged, the solute mass for a target percent is (percent ÷ 100) × total solution mass, so a 250 g batch of a 4% solution needs 10 g of solute and 240 g of solvent.',
    ...
    faqs: [
      ...
      { q: 'How do I dilute a mass-percent solution?', a: 'Add solvent while keeping the solute mass fixed. Adding 100 g of water to 100 g of a 20% solution (20 g solute) gives 20 g ÷ 200 g × 100 = 10%.' },
      { q: 'How does mass percent relate to ppm?', a: '1% by mass equals 10,000 ppm, so mass percent × 10,000 gives ppm. A 0.005% solution is 50 ppm, use ppm when the solute is only a trace amount.' },
...
CHEM_TOOLS.push(
  ...
  },
  {
    ...
    how: 'Moles = mass ÷ molar mass; particles = moles × Avogadro’s number (6.02214076×10²³). Enter a chemical formula and the molar mass is computed from atomic weights; give any one of mass, moles or particles and the tool returns the other two. So mass = moles × molar mass, and moles = particles ÷ Avogadro’s number, letting you move freely between all three, one mole of carbon-12 is 12 g and contains 6.022×10²³ atoms.',
    ...
    faqs: [
      ...
      { q: 'How many molecules are in 18 g of water?', a: 'That is one mole (18.015 g/mol), so 6.022×10²³ molecules. Halve the mass to 9 g and you have half a mole, 3.011×10²³ molecules.' },
      { q: 'How do I convert particles back to grams?', a: 'Divide the particle count by Avogadro’s number to get moles, then multiply by the molar mass. 1.2×10²⁴ molecules of water ÷ 6.022×10²³ = 1.99 mol × 18.015 ≈ 35.9 g.' },
    ],
  ...
  },
  {
    ...
    how: 'Each element’s amount is divided by its atomic weight to get moles, then all mole values are divided by the smallest and scaled to whole numbers, that ratio is the empirical formula. If you provide the compound’s molar mass, the tool divides it by the empirical-formula mass to find the whole-number multiple and hence the molecular formula. For instance, a compound that is 40.0% C, 6.7% H and 53.3% O gives 3.33 : 6.64 : 3.33 mol, which divides down to 1 : 2 : 1, the empirical formula CH₂O.',
    ...
    faqs: [
      ...
      { q: 'How do I handle a ratio like 1 : 1.33?', a: 'Multiply every term by the smallest whole number that clears the fraction. 1.33 ≈ 4/3, so multiply by 3 to get 3 : 4. Common decimals: .5 → ×2, .33/.67 → ×3, .25/.75 → ×4.' },
      { q: 'Why do I need the molar mass for the molecular formula?', a: 'The empirical formula only gives the ratio, not the true size. Dividing the actual molar mass by the empirical-formula mass gives the multiplier n; multiply every subscript by n. For CH₂O (30.03 g/mol) with a molar mass of 180 g/mol, n = 6, giving C₆H₁₂O₆.' },
    ],
  ...
  },
  {
    ...
    how: 'Percent yield = (actual yield ÷ theoretical yield) × 100. Enter any two of the three and the tool solves for the third; actual and theoretical must be in the same units. Rearranged, actual = (percent yield ÷ 100) × theoretical, and theoretical = actual ÷ (percent yield ÷ 100), so you can back out whichever value you are missing.',
    ...
    faqs: [
      ...
      { q: 'If theoretical yield is 15 g and I recovered 12 g, what is my percent yield?', a: '12 ÷ 15 × 100 = 80%. Enter 12 as actual and 15 as theoretical to confirm.' },
      { q: 'How do I get the expected actual yield for a target percent?', a: 'Multiply the theoretical yield by the fraction. For an 85% yield of a reaction with a 20 g theoretical maximum, expect 20 × 0.85 = 17 g.' },
      { q: 'Does percent yield measure purity?', a: 'Not directly. It measures how much product you recovered versus the maximum possible. A high yield of impure product is possible, which is why yields above 100% usually signal contamination or trapped solvent rather than a great reaction.' },
      { q: 'How does the limiting reagent affect percent yield?', a: 'The theoretical yield is always based on the limiting reagent, the reactant that runs out first. Using the wrong reactant (one in excess) to compute theoretical yield inflates it and makes the percent yield look artificially low.' },
      { q: 'Should I use moles or grams for percent yield?', a: 'Either works, as long as actual and theoretical are in the same unit, because percent yield is a ratio. Just be sure both refer to the same product, since the ratio cancels the units.' },
    ],
  ...
  },
  {
    ...
    how: 'For a dilution, moles of solute are conserved, so C₁V₁ = C₂V₂ (stock concentration × stock volume = final concentration × final volume). Enter any three values and the tool solves for the missing one; the concentration units cancel, so any consistent unit works. The equation holds because diluting adds only solvent, leaving the amount of solute (concentration × volume) unchanged, so you can solve for any one of C₁, V₁, C₂ or V₂.',
    ...
    faqs: [
      ...
      { q: 'What is the dilution factor?', a: 'The ratio of final to initial volume, or equivalently initial to final concentration. Diluting 10 mL of 2 M stock to 100 mL is a 10× dilution (2 M → 0.2 M).' },
      { q: 'Can I dilute by percentage instead of molarity?', a: 'Yes, treat the percentages as the concentrations, since their units cancel. Diluting a 30% solution to 5% in 200 mL needs V₁ = (5 × 200) ÷ 30 = 33.3 mL of the 30% solution, topped up to 200 mL.' },
      { q: 'How much solvent do I add to dilute a solution?', a: 'Find the stock volume V₁ needed, then add solvent up to the final volume V₂, the added solvent is V₂ − V₁. To make 250 mL of 0.2 M from a 1 M stock, use 50 mL of stock and add 200 mL of solvent.' },
      { q: 'Does C₁V₁ = C₂V₂ work for concentrating a solution?', a: 'No, the equation only conserves solute while adding solvent, so it describes dilution (C₂ < C₁). Concentrating means removing solvent by evaporation, which this relationship does not model.' },
    ],
  ...
  },
  {
    ...
    how: 'Density is mass per unit volume: ρ = m/V. Enter any two of density, mass and volume and the tool solves for the third; keep units consistent (g and mL give g/mL). Rearranged, mass = ρ × V and volume = m ÷ ρ, so any two of the three give the third. Density is an intensive property. It does not depend on sample size, which makes it a reliable fingerprint for identifying a material or checking its purity.',
    ...
    faqs: [
      ...
      { q: 'How do I find the mass of a volume of liquid?', a: 'Multiply the volume by the density: mass = ρ × V. 500 mL of ethanol (ρ ≈ 0.789 g/mL) weighs 500 × 0.789 = 394.5 g.' },
      { q: 'Why do some objects float?', a: 'An object floats in a liquid when it is less dense than that liquid. Ice (≈0.92 g/mL) floats on water (≈1.00 g/mL); most metals sink because their density far exceeds water’s.' },
      { q: 'Does density change with temperature?', a: 'Yes, most substances expand when heated, lowering their density, because the mass is unchanged while the volume grows. Water is unusual, reaching maximum density near 4 °C. For precise work, quote the temperature with the density.' },
      { q: 'What is specific gravity, and how does it relate to density?', a: 'Specific gravity is the ratio of a substance’s density to water’s (≈1.00 g/mL), so it is a unitless number. A liquid of density 1.25 g/mL has a specific gravity of about 1.25 and sinks in water.' },
      { q: 'What is the difference between density and mass?', a: 'Mass is the total amount of matter; density is mass packed into a given volume (mass ÷ volume). Two objects can share a mass yet differ in density, a kilogram of feathers occupies far more volume than a kilogram of lead.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'What ratio of base to acid gives a target pH?', a: 'Rearrange to [A⁻]/[HA] = 10^(pH − pKa). To buffer at pH 5.76 with an acid of pKa 4.76, you need a ratio of 10¹ = 10 parts conjugate base to 1 part acid.' },
      { q: 'How do I choose an acid for a buffer?', a: 'Pick one whose pKa is within about one unit of your target pH, so the base:acid ratio stays between roughly 1:10 and 10:1. A phosphate buffer (pKa₂ ≈ 7.2) suits physiological pH 7.4, for instance.' },
      { q: 'What is buffer capacity?', a: 'The amount of acid or base a buffer can absorb before its pH shifts significantly. It is greatest when [A⁻] = [HA] (pH = pKa) and rises with the total concentration of the buffer components.' },
      { q: 'Does the Henderson, Hasselbalch equation account for strong acids or bases?', a: 'No. It assumes a weak acid and its conjugate base at equilibrium. For a strong acid or base, which ionises completely, calculate the pH directly from the concentration instead of using this equation.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How do I find concentration from a calibration curve?', a: 'Plot absorbance against known concentrations; the slope equals ε·l. Divide any measured absorbance by that slope to read off concentration, the graphical form of c = A/(εl).' },
      { q: 'What does an absorbance of 1 mean?', a: 'Absorbance is logarithmic: A = 1 means 10% of the light is transmitted (90% absorbed), and A = 2 means 1% transmitted. Because it is a log scale, doubling absorbance is not the same as doubling the light lost.' },
      { q: 'How is absorbance related to transmittance?', a: 'A = −log₁₀(T), where T is the fraction of light transmitted. So 50% transmittance (T = 0.5) is an absorbance of about 0.30, and 10% transmittance is exactly A = 1.' },
      { q: 'Why keep the path length at 1 cm?', a: 'It is the standard cuvette width, so tabulated ε values (M⁻¹cm⁻¹) apply directly and A equals ε·c numerically. If you use a different path length, scale by it, a 2 cm cell doubles the absorbance at the same concentration.' },
    ],
  ...
  },
  {
    ...
    how: 'For a fixed amount of gas, P₁V₁/T₁ = P₂V₂/T₂, with temperatures in kelvin. Enter any five of the six quantities and the tool solves for the missing one. Holding one variable constant recovers Boyle’s law (PV constant), Charles’s law (V/T constant) and Gay-Lussac’s law (P/T constant). Solving for a final state, for instance, gives V₂ = V₁·(P₁/P₂)·(T₂/T₁); as a check, a 2 L gas at 300 K heated to 600 K at constant pressure expands to 4 L.',
    ...
    faqs: [
      ...
      { q: 'A gas is 1 L at 2 atm and 300 K, what volume at 1 atm and 300 K?', a: 'Temperature is constant, so this is Boyle’s law: P₁V₁ = P₂V₂, giving V₂ = (2 × 1) ÷ 1 = 2 L. Halving the pressure doubles the volume.' },
      { q: 'Do I need the amount of gas (moles)?', a: 'No, the combined gas law assumes a fixed amount of gas, so n cancels. If the amount changes as well, use the full ideal gas law PV = nRT instead.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How much of a sample remains after 3 half-lives?', a: '(½)³ = 1/8, or 12.5%. After 4 half-lives it is 1/16 (6.25%). Each half-life multiplies what is left by one half.' },
      { q: 'How is half-life related to the decay constant?', a: 'By t½ = ln 2 ÷ λ ≈ 0.693/λ, where λ is the first-order rate constant. A larger λ (faster decay) means a shorter half-life.' },
      { q: 'How long until a sample decays to 10% of its original amount?', a: 'Solve t = t½ · log₂(N₀/N) with N₀/N = 10: log₂(10) ≈ 3.32, so it takes about 3.32 half-lives. For a 6-hour half-life that is roughly 20 hours.' },
      { q: 'Why does a radioactive sample never reach exactly zero?', a: 'Decay is exponential, so each half-life removes half of what remains, not a fixed amount. The quantity approaches zero but never mathematically reaches it, which is why decay is described by half-lives rather than a fixed lifetime.' },
    ],
...
CHEM_TOOLS.push(
  {
    ...
    how: 'Gibbs free energy is ΔG = ΔH − TΔS, with ΔH in kJ/mol, ΔS in J/(mol·K) and T in kelvin (the tool handles the kJ/J unit conversion). Enter any three and it solves for the fourth. A negative ΔG means the reaction is spontaneous (product-favoured) at that temperature. The crossover temperature, where ΔG changes sign, is T = ΔH/ΔS; for example, with ΔH = +178 kJ/mol and ΔS = +160 J/(mol·K) the reaction becomes spontaneous above 178,000 ÷ 160 ≈ 1113 K.',
    ...
    faqs: [
      ...
      { q: 'What do the four sign combinations of ΔH and ΔS mean?', a: 'ΔH−/ΔS+: spontaneous at all temperatures. ΔH+/ΔS−: never spontaneous. ΔH−/ΔS−: spontaneous only at low temperature. ΔH+/ΔS+: spontaneous only at high temperature. The −TΔS term settles the temperature-dependent cases.' },
      { q: 'How does ΔG relate to the equilibrium constant?', a: 'Through ΔG° = −RT ln K. A negative ΔG° means K > 1 (products favoured); ΔG° = 0 means K = 1. This tool computes ΔG from ΔH, T and ΔS; the K link uses that result.' },
    ],
  ...
  },
  {
    ...
    how: 'At 25 °C the Nernst equation is E = E° − (0.0592/n)·log₁₀(Q), where E° is the standard cell potential, n the number of electrons transferred, and Q the reaction quotient. Enter any three of E, E°, n, Q and the tool solves for the fourth. Rearranged, E° = E + (0.0592/n)·log Q, and Q can be solved from a measured potential; every tenfold change in Q shifts the potential by 0.0592/n volts.',
    ...
    faqs: [
      ...
      { q: 'A cell has E° = 1.10 V, n = 2, Q = 10, what is E?', a: 'E = 1.10 − (0.0592/2)·log 10 = 1.10 − 0.0296 × 1 = 1.07 V. Raising Q (more product) lowers the cell potential.' },
      { q: 'How does the Nernst equation give the equilibrium constant?', a: 'At equilibrium E = 0 and Q = K, so 0 = E° − (0.0592/n)·log K, giving log K = nE°/0.0592. A larger standard potential means a much larger K.' },
      { q: 'How does concentration change a cell’s voltage?', a: 'Through Q: raising product-ion concentration or lowering reactant-ion concentration increases Q and lowers E, while the reverse raises E. This is how concentration cells generate a voltage from the same electrode material at two different concentrations.' },
      { q: 'Why is the Nernst equation important for pH and ion-selective electrodes?', a: 'A pH meter is an electrochemical cell whose voltage depends on [H⁺] through the Nernst relation. Each pH unit (a tenfold change in [H⁺]) shifts the electrode potential by about 0.0592 V, which the meter converts back to pH.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'What does the pre-exponential factor A represent?', a: 'A (the frequency factor) reflects how often reactant molecules collide with the correct orientation. In k = A·e^(−Ea/RT) it sets the ceiling rate that would apply if every collision had enough energy.' },
      { q: 'How do I read Ea from an Arrhenius plot?', a: 'Plot ln k against 1/T; the points fall on a line of slope −Ea/R. Multiply the slope by −R (8.314) to get the activation energy in J/mol.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'What freezing point does 2 m CaCl₂ give in water?', a: 'ΔTf = i·Kf·m = 3 × 1.86 × 2 = 11.16 °C, so the solution freezes near −11.2 °C. CaCl₂’s i ≈ 3 (one Ca²⁺ plus two Cl⁻) makes it a strong de-icer.' },
      { q: 'How is freezing-point depression used to find molar mass?', a: 'Measure ΔTf for a known mass of an unknown solute, back out the molality from ΔTf = Kf·m, convert to moles, then divide the solute mass by the moles. This “cryoscopy” yields the molar mass of the unknown.' },
    ],
  ...
  },
  {
    ...
    how: 'Boiling-point elevation is a colligative property: ΔTb = i·Kb·m, where i is the van’t Hoff factor, Kb the ebullioscopic constant (0.512 °C·kg/mol for water), and m the molality. Enter any three and the tool solves for the fourth. Rearranged, the molality is m = ΔTb ÷ (i·Kb), and the solution’s boiling point is the pure solvent’s plus ΔTb, for water, 100 °C + ΔTb.',
    ...
    faqs: [
      ...
      { q: 'What is the boiling point of 1 m NaCl in water?', a: 'ΔTb = i·Kb·m = 2 × 0.512 × 1 = 1.02 °C, so the solution boils at about 101.0 °C. NaCl gives i ≈ 2 because it splits into Na⁺ and Cl⁻.' },
      { q: 'Does salting pasta water make it boil faster?', a: 'No, dissolved salt raises the boiling point slightly (a teaspoon per litre barely moves it), so the water ends up marginally hotter but takes a little longer, not less time, to boil. The salt is for flavour, not speed.' },
    ],
  ...
  },
  {
    ...
    how: 'Parts per million is a mass fraction scaled by a million: ppm = (mass of solute ÷ mass of solution) × 10⁶, with both masses in the same unit. Enter any two of solute mass, solution mass and ppm and the tool solves for the third. For dilute aqueous solutions, 1 ppm ≈ 1 mg/L. The same scaling extends to related units: 1 ppm = 10⁻⁴ %, 1000 ppb, and, for dilute water, about 1 mg/L or 1 µg/mL.',
    ...
    faqs: [
      ...
      { q: 'How many grams of solute are in 2 L of a 50 ppm solution?', a: 'For dilute water, 50 ppm ≈ 50 mg/L, so 2 L holds 100 mg = 0.1 g. For non-aqueous or concentrated solutions, use the mass definition with the actual solution mass.' },
      { q: 'How do I convert a percentage to ppm?', a: 'Multiply the percent by 10,000, since 1% = 10,000 ppm. A 0.0025% solution is 25 ppm.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'A measurement gives 9.6 g/mL but the accepted value is 10.5, what is the percent error?', a: '|9.6 − 10.5| ÷ 10.5 × 100 = 8.6%. The signed error is −8.6%, showing the measurement came out low.' },
      { q: 'What causes percent error in an experiment?', a: 'Systematic errors (a miscalibrated instrument, a consistent reading bias) and random errors (fluctuations you can average out). Percent error captures the combined gap between your result and the accepted value.' },
      { q: 'How can I reduce percent error?', a: 'Calibrate instruments, repeat measurements and average them, control conditions like temperature, and use appropriate significant figures. A smaller percent error means better accuracy relative to the accepted value.' },
      { q: 'What is the difference between percent error and standard deviation?', a: 'Percent error measures accuracy, how close a result is to the accepted value. Standard deviation measures precision, how tightly repeated measurements cluster together. A set of readings can be precise (low spread) yet inaccurate (high percent error).' },
      { q: 'What if I don’t have an accepted value to compare against?', a: 'Then percent error does not apply, because it needs a known reference. Compare two experimental values with percent difference instead, dividing their absolute difference by their average.' },
    ],
...
CHEM_TOOLS.unshift(
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can I use fractional abundances instead of percentages?', a: 'Yes, enter 75.77 as a percent or 0.7577 as a fraction, as long as you are consistent. Percentages should total 100; fractions should total 1.' },
      { q: 'How do I find an unknown abundance from the average mass?', a: 'For two isotopes, let the first fraction be x and the second (1 − x): set mass₁·x + mass₂·(1 − x) equal to the known average and solve for x. Chlorine’s 35.45 average solves to about 76% chlorine-35.' },
      { q: 'Why does the average mass sit closer to one isotope than the other?', a: 'It is weighted toward the more abundant isotope. Copper’s 63.55 lies near copper-63 (62.93 u) because about 69% of copper atoms are that isotope, versus 31% copper-65.' },
      { q: 'Is average atomic mass the same as atomic weight?', a: 'In everyday use, yes, both refer to the abundance-weighted average mass of an element’s isotopes shown on the periodic table. Strictly, “relative atomic mass” is the dimensionless value and this average is what the table reports.' },
    ],
