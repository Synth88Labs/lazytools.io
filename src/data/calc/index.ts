...
export const CALCULATORS: CalcDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'width', label: 'Width', type: 'number', placeholder: '10', defaultValue: '10', min: 0 },
      { id: 'unit', label: 'Units', type: 'select', defaultValue: 'ft', options: [
        { value: 'ft', label: 'Feet' },
        { value: 'm', label: 'Metres' },
      ] },
      { id: 'quantity', label: 'Number of identical areas', type: 'number', placeholder: '1', defaultValue: '1', min: 1, step: 1 },
    ],
    computeId: 'squareFootage',
    formula: 'Area = length × width. For a rectangular room, multiply the two sides in the same unit. To cover several identical rooms or sections, multiply that area by the count. 1 ft² = 0.092903 m²; 1 m² = 10.7639 ft².',
    example: 'A 12 ft × 10 ft room is 120 ft², which is 120 × 0.092903 ≈ 11.15 m². Four such rooms total 480 ft².',
    note: 'For L-shaped or irregular spaces, split them into rectangles, work out each area separately and add them up. For flooring, paint or tile, add a waste allowance (usually 5–10%) on top of the bare square footage before you buy.',
    faqs: [
      { q: 'How do I calculate square footage?', a: 'Measure the length and width in feet and multiply them: a 12 ft by 10 ft room is 12 × 10 = 120 square feet. Keep both measurements in the same unit before multiplying.' },
      { q: 'How do I find the square footage of an irregular room?', a: 'Divide the space into rectangles, calculate each rectangle\'s area (length × width) separately, and add them together. This handles L-shaped rooms and alcoves.' },
      { q: 'How many square feet are in a square metre?', a: 'One square metre equals about 10.764 square feet, and one square foot equals 0.092903 square metres. This calculator shows both units at once.' },
      { q: 'How do I convert room dimensions in inches?', a: 'Divide inches by 12 to get feet first (e.g. 144 in = 12 ft), then multiply length by width. Or measure in metres and switch the unit selector.' },
      { q: 'Should I add extra for flooring or paint?', a: 'Yes — add a waste allowance, typically 5–10% for flooring and tile to cover cuts and mistakes. Calculate the bare square footage here, then multiply by 1.05–1.10.' },
    ],
    keywords: ['square footage calculator', 'square feet calculator', 'room area calculator', 'sq ft calculator', 'area calculator feet', 'square meter calculator', 'how to calculate square footage'],
  },
  {
    ...
    fields: [
      ...
      { id: 'area', label: 'Area', type: 'number', placeholder: '1800', defaultValue: '1800', min: 0 },
      { id: 'unit', label: 'Area is in', type: 'select', defaultValue: 'ft2', options: [
        { value: 'ft2', label: 'Square feet' },
        { value: 'm2', label: 'Square metres' },
      ] },
    ],
    computeId: 'costPerArea',
    formula: 'Cost per unit area = total price ÷ area. Divide the price by the floor area to normalise it, so two differently sized options can be compared directly. The result is shown per square foot and per square metre (1 ft² = 0.092903 m²).',
    example: 'A $350,000 home of 1,800 ft² is 350,000 ÷ 1,800 ≈ $194.44 per square foot, or about $2,093 per square metre.',
    note: 'Price per square foot is the standard way to compare real estate, rents and materials of different sizes, but it ignores quality, location, condition and layout — treat it as one input, not the whole decision. For rentals, divide the monthly rent by the area to compare listings.',
    faqs: [
      { q: 'How do I calculate cost per square foot?', a: 'Divide the total price by the area in square feet: a $350,000 home of 1,800 ft² is 350,000 ÷ 1,800 ≈ $194 per square foot. It normalises price so differently sized options compare fairly.' },
      { q: 'Why compare price per square foot?', a: 'It puts homes, rentals or materials of different sizes on the same scale, so you can see which is objectively more expensive per unit of space rather than just by sticker price.' },
      { q: 'What are its limitations?', a: 'Price per square foot ignores location, condition, quality of finish, layout and land. A well-located, renovated home can be worth a higher price per square foot — use it as one factor among several.' },
      { q: 'How do I get cost per square metre?', a: 'Divide the price by the area in square metres, or switch the unit selector — this tool shows both per square foot and per square metre automatically.' },
      { q: 'Can I use this for rent?', a: 'Yes — enter the monthly rent as the price and the unit\'s area to get rent per square foot, a handy way to compare apartment listings of different sizes.' },
    ],
    keywords: ['cost per square foot calculator', 'price per square foot calculator', 'cost per sq ft', 'price per square meter', 'rent per square foot', 'real estate price per square foot', 'material cost per square foot'],
  },
  {
    ...
    fields: [
      ...
      { id: 'total', label: 'Total mixture to make', type: 'number', placeholder: '1000', defaultValue: '1000', min: 0 },
      { id: 'unit', label: 'Volume unit', type: 'select', defaultValue: 'mL', options: [
        { value: 'mL', label: 'mL' },
    ...
    computeId: 'mixRatio',
    formula: 'A dilution ratio of 1:N means 1 part concentrate to N parts water, so there are (1 + N) total parts. Concentrate = total volume ÷ (1 + N); water = total − concentrate. For 1:10, that is 1 part in every 11.',
    example: 'To make 1,000 mL at 1:10, total parts = 11, so concentrate = 1000 ÷ 11 ≈ 90.9 mL and water ≈ 909.1 mL.',
    note: 'Dilution ratios are usually written as 1:N (concentrate : water) — 1:10 means one part cleaner to ten parts water, giving eleven parts total, not ten. Always check whether the label means "parts water" (this tool\'s convention) or "total parts"; when in doubt, follow the manufacturer\'s directions. For chemical concentration (molarity, ppm) rather than mixing ratios, use a C₁V₁ = C₂V₂ dilution instead.',
    faqs: [
      { q: 'How do I calculate a dilution ratio?', a: 'For a 1:N ratio, divide the total volume by (1 + N) to get the concentrate, and the rest is water. To make 1,000 mL at 1:10, that\'s 1000 ÷ 11 ≈ 91 mL concentrate and 909 mL water.' },
      { q: 'Does 1:10 mean 10 parts total or 11?', a: 'Eleven. A 1:10 ratio is 1 part concentrate to 10 parts water, which is 11 parts in total — the concentrate is 1/11 (about 9.1%) of the mix, not 1/10. This is the most common source of dilution mistakes.' },
      { q: 'How much concentrate for a gallon at 1:20?', a: 'One gallon is 128 fl oz. At 1:20 there are 21 parts, so concentrate = 128 ÷ 21 ≈ 6.1 fl oz and the rest is water. Switch the unit to gallons or fl oz to match your bottle.' },
      { q: 'What is the difference between 1:10 and 10%?', a: 'They\'re close but not equal. 1:10 (parts water) is 1/11 ≈ 9.1% concentrate, whereas a 10% solution is exactly 1 part in 10. For cleaning products the parts convention is standard; for lab work, percent or molarity is used.' },
      { q: 'Can I use this for coolant, pesticides or fertiliser?', a: 'Yes, for anything mixed by volume ratio — antifreeze, garden sprays, cutting fluid, cleaning concentrate. Always follow the product label\'s stated ratio and safety directions; this tool just does the arithmetic.' },
    ],
