...
export const CALCULATORS: CalcDef[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Why is so much of my early EMI interest rather than principal?', a: 'Interest is charged on the outstanding balance, which is largest at the start, so early instalments are mostly interest and later ones mostly principal, even though the EMI amount stays the same. This is called amortisation.' },
      { q: 'Does a longer loan tenure reduce the total cost?', a: 'No, a longer tenure lowers the monthly EMI but increases the total interest paid, because you owe the balance for longer. A shorter tenure means higher EMIs but less interest overall.' },
    ],
