...
export const ASTRO_TOOLS: AstroToolDef[] = [
  ...
  },
  {
    ...
    name: 'Light Travel Time Calculator',
    icon: '🌠',
    widget: 'lighttime',
  ...
  },
  {
    ...
    icon: '🔭',
    widget: 'telescope',
    description: 'Calculate telescope magnification, focal ratio, exit pupil, resolving power (Dawes/Rayleigh) and maximum useful magnification from focal length, aperture…',
  ...
  },
  {
    ...
    name: 'Parallax Distance Calculator',
    icon: '✨',
    widget: 'parallax',
    description: 'Convert a star\'s parallax angle to its distance (in parsecs, light-years and km) and back — the fundamental method for measuring stellar distances. In your…',
  ...
  },
  {
    ...
    name: 'Golden & Blue Hour Calculator',
    icon: '🌅',
    widget: 'goldenhour',
    description: 'Find the golden hour, blue hour and twilight times for any date and location — the best light for photography — computed with the NOAA solar algorithm. In…',
  ...
  },
  {
    ...
    name: 'Star Magnitude Calculator',
    icon: '✨',
    widget: 'magnitude',
