...
`P:p\;ass\:word`. Get this wrong and the code either fails to scan or joins with the wrong password, which is maddening to debug because the QR *looks* fine. The
