...
**`chmod 755` sets `rwxr-xr-x`, full control for the owner, read-and-execute for everyone else, and once you know that each digit is just read (4) + write (2) + execute (1) added up, every chmod
