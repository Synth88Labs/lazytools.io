...
Base32 and Base64 are two answers to one question, how to carry bytes through a text-only channel, and the right answer is whichever matches who handles the value. Base64 is compact for machines;
