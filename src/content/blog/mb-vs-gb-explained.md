...
([NIST's binary-prefix reference](https://physics.nist.gov/cuu/Units/binary.html) documents them), created specifically to end the two-meanings-of-kilobyte ambiguity.
...
*All conversions use exact definitions, SI decimal prefixes and IEC/ISO 80000-13 binary prefixes, verified by [our public test suite](https://github.com/Synth88Labs/lazytools.io). Related tools:
