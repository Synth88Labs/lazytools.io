...
The bottom strand is the complement, but it is written 3′→5′. To express it the normal way, 5′→3′, read it right to left: `ATGCCAT`. That string, `ATGCCAT`, is the reverse complement of `ATGGCAT`.
