...
**A phone photo taken with location services on carries GPS coordinates accurate to a few meters, along with the device model, exact capture time and more, in an invisible block called EXIF, and
