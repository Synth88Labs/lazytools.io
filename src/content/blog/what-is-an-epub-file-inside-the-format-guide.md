...
A reader doesn't guess where the book's data is. It opens the one file at a fixed location, `META-INF/container.xml`, which contains a single important line pointing at the package document:
