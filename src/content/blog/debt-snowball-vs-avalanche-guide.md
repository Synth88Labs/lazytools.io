...
*Sources: for the underlying mechanics and the behavioural evidence on debt paydown, see the [Consumer Financial Protection Bureau](https://www.consumerfinance.gov/) and research summarised by the [Harvard Business Review, "Research: The Power of Small Wins in Debt Repayment"](https://hbr.org/2016/12/research-the-best-strategy-for-paying-off-credit-card-debt). Interest and payoff figures above are computed by LazyTools' own month-by-month amortization for the example shown.*
