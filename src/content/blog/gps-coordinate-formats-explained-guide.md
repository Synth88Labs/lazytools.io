...
latitude is **N**, negative is **S**. Dropping that sign is the single most common conversion mistake —
`-0.1278` is west of Greenwich, and writing it as an east value would place you on the wrong side of the
Prime Meridian.
...
two eastings really is a distance in metres, which makes it easy to measure and lay out on the ground —
as long as you stay inside one zone, since the grid resets at each boundary.
