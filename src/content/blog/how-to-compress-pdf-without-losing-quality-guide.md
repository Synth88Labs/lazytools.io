...
and objects so the same document takes less space. It's the safe default and it's often all you need, just don't expect it to work miracles on a file that's mostly high-resolution images, where the only
