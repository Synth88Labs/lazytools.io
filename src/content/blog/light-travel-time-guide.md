...
keywords:
  ...
  - how long does light take from the sun
  - speed of light distance
  - looking back in time astronomy
heroImage: /blog/light-travel-time-guide.png
heroAlt: "Light travel times: Moon 1.3s, Sun 8 min, nearest star 4.24 years, Andromeda 2.5 million years ago"
faqs:
  - q: "Why do we see stars as they were in the past?"
    a: "Because light takes time to travel, and stars are enormously far away. The light entering your eye tonight left the star years, centuries or millennia ago, so you're literally seeing it as it was back then, not as it is now."
  - q: "How long does light take to reach Earth from the Sun?"
    a: "About 8 minutes and 20 seconds. The Sun is one astronomical unit (149.6 million km) away, and light covers that in roughly 500 seconds. If the Sun vanished, we wouldn't know for over 8 minutes."
  - q: "What is a light-year?"
    a: "The distance light travels in one year, about 9.46 trillion kilometres. It's a measure of distance, not time, and it's how astronomers describe the huge gaps between stars."
  - q: "How far away is the nearest star?"
    a: "Proxima Centauri is about 4.24 light-years away, so its light takes over four years to reach us. We see it as it was more than four years ago."
  - q: "Could a star we see already be gone?"
    a: "For very distant stars, yes, a star thousands of light-years away could have died since its light set out, and we'd still see it shining until that last light arrives. For nearby stars it's very unlikely, since their light is only a few years old."
  - q: "How fast does light travel?"
    a: "Exactly 299,792.458 kilometres per second in a vacuum, about 300,000 km/s. It's the universe's speed limit; nothing carrying information can go faster."
  - q: "How far back can we see?"
    a: "The most distant light we can detect, the cosmic microwave background, left its source about 13.8 billion years ago, so looking deep into space is looking almost all the way back to the Big Bang."
draft: false
---
...
- **Light travels at 299,792 km/s**, fast, but finite.
- You see the **Moon 1.3 s ago**, the **Sun ~8 min ago**, the **nearest star ~4.2 years ago**.
- A **light-year is a distance** (~9.46 trillion km), not a time.
- The farther the object, **the older the light**, distant galaxies are seen millions of years back.
- Some very distant stars we see **may no longer exist**.
...
<figure>
<img src="/blog/light-travel-time-guide.png" alt="Ladder of light travel times: the Moon 1.3 seconds ago, the Sun 8 minutes 20 seconds ago, Mars ~12 minutes, Jupiter ~43 minutes, Neptune ~4 hours, Proxima Centauri 4.24 years, the Andromeda galaxy 2.5 million years ago." width="1200" height="640" loading="lazy" />
...
So the next time you glance at the night sky, remember: you're not seeing the universe as it is. You're seeing a mosaic of different pasts, each point of light a snapshot from a different moment in cosmic history. Curious how far back? The [light travel time calculator](/astronomy/light-travel-time-calculator/) and the [parallax distance calculator](/astronomy/parallax-distance-calculator/) turn distances into times, privately, in your browser.
