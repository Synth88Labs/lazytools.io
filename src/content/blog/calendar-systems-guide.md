...
Calendar conversion is deterministic maths, but it's fiddly maths that's easy to get wrong by hand, leap months, variable month lengths, drifting epochs. The good news is that your browser already
