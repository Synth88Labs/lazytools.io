...
**IPv6 stopped being the future in March 2026, when it crossed 50% of user traffic to Google, and subnetting it is genuinely easier than IPv4, once you unlearn one habit: stop counting hosts
...
that measurement [crossed 50%](https://blog.apnic.net/2026/04/28/google-hits-50-ipv6/), eighteen years from under 1% to majority, as the
...
SLAAC) and unreadable plans. The address space is the one resource you genuinely have in excess, spend it on structure.
