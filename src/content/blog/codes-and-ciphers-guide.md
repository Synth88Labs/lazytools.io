...
**[Morse code](/cipher/morse-code-translator/)** represents each character as short and long signals, dots and dashes. A dash is three times the length of a dot; letters are separated by a medium gap and
...
**[The NATO phonetic alphabet](/cipher/nato-phonetic-alphabet/)**, Alfa, Bravo, Charlie through Zulu, solves a spoken-channel problem: letters like B, P, T and V sound alike over a crackly phone line, so
