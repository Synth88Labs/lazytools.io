...
target. The [accessible-color generator](/color/accessible-color-generator/) does this search for you, enter the foreground, background and target, and it returns the nearest passing color, lighter and darker.
...
patterns or direct labels, not just a color legend. Do that, and the design works for everyone, color-blind or not, on a cheap display or in bright sunlight.
