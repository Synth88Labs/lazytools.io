...
archetype: explainer
heroImage: /blog/aquarium-stocking-inch-per-gallon-guide.png
heroAlt: "A comparison showing one ten-inch fish produces far more waste than ten one-inch fish, disproving the inch per gallon rule."
tools: ["/pets/aquarium-stocking-calculator/", "/pets/aquarium-volume-calculator/", "/pets/aquarium-heater-size-calculator/"]
keywords:
...
<figure>
<img src="/blog/infographic-aquarium-stocking.svg" alt="Doubling a fish's length roughly gives eight times the body volume, so one ten inch fish produces far more waste than ten one inch fish. What matters instead is adult size, bioload, surface area, filtration and territory." width="1200" height="700" loading="lazy" />
<figcaption>The rule treats inches as interchangeable. Biology doesn't.</figcaption>
</figure>
...
Both are "10 inches of fish." They are not remotely equivalent loads on a filter. And it gets worse: a fish like an oscar is also *deep-bodied*, so even the cube estimate understates it against a slim, torpedo-shaped tetra.

## The adult-size trap

This is the mistake that causes most genuine suffering. Fish are sold as juveniles, and the inch rule tempts people to stock by the size in the bag.
...
- Ammonia or nitrite readings above **0 ppm** in an established tank
- Nitrate climbing quickly between water changes
- Fish gasping at the surface (an oxygen problem)
- Persistent cloudiness or a recurring bacterial bloom
- Increased aggression as territories compress
...
### Should I stock a new tank all at once?
No. A new tank's beneficial bacteria haven't established, so it can't process much ammonia yet. Cycle the tank first, then add fish gradually over weeks, testing as you go, to let the bacterial colony grow with the load.
