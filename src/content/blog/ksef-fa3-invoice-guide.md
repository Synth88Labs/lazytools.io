...
structural checks (required elements, date and currency formats, line items, totals consistency) —
clearly labelled as an **unofficial** early warning, because only KSeF's own acceptance has legal
effect.
