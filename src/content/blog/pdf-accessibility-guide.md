...
it covers private-sector *services*, e-commerce, consumer banking, e-books, passenger transport, and the documents those services produce. A bank statement, an online-shop invoice, an e-book, a
...
**Tags** are the big one. A tagged PDF carries a structure tree labelling every piece of content, heading, paragraph, list, table, figure, in reading order. That tree *is* what assistive
