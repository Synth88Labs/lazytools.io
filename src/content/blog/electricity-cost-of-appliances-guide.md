...
archetype: explainer
heroImage: /blog/electricity-cost-of-appliances-guide.png
heroAlt: "Running cost = (watts ÷ 1000) × hours × price per kWh."
tools: ["/calc/electricity-cost-calculator/"]
keywords:
...
- **Formula:** cost = (watts ÷ 1000) × hours used × price per kWh.
- Electricity is billed in **kilowatt-hours** — 1000 watts running for one hour = 1 kWh.
- Find **wattage** on the rating label; if only volts and amps are shown, watts = volts × amps.
- **Fridges, ACs and freezers cycle on and off** — use their average on-time (or annual kWh label), not a full 24 hours.
- The maths is currency-agnostic — enter your rate in whatever your bill uses.

</aside>

<figure>
<img src="/blog/infographic-electricity-cost.svg" alt="cost = (watts ÷ 1000) × hours × price per kWh. A 1500 W heater used 5 h/day at $0.20/kWh costs $1.50/day, ~$45/month, ~$547/year." width="1200" height="700" loading="lazy" />
<figcaption>Watts, hours and your kWh price are all you need to turn power into pounds or dollars.</figcaption>
</figure>
