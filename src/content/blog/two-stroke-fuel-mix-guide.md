...
archetype: explainer
heroImage: /blog/two-stroke-fuel-mix-guide.png
heroAlt: "Two-stroke oil equals the fuel volume divided by the ratio number."
tools: ["/automotive/two-stroke-fuel-mix-calculator/"]
keywords:
  - two stroke fuel mix
  - 50 to 1 fuel mix
  - 40:1 mix ratio
...
<figure>
<img src="/blog/infographic-two-stroke.svg" alt="Two-stroke oil = fuel ÷ ratio number. For 5 litres of petrol: 50:1 needs 100 ml of oil, 40:1 needs 125 ml, 32:1 needs 156 ml." width="1200" height="700" loading="lazy" />
<figcaption>One rule covers every ratio: divide the fuel by the ratio number to get the oil.</figcaption>
</figure>
...
- **32:1** = 32 parts petrol to 1 part oil
...
To find the oil for any amount of fuel:

> **oil = fuel volume ÷ ratio number**

Convert the fuel to millilitres first (or use the [two-stroke fuel mix calculator](/automotive/two-stroke-fuel-mix-calculator/) to do it instantly in ml and fluid ounces):

- **1 litre at 50:1** → 1000 ÷ 50 = **20 ml** of oil
- **5 litres at 50:1** → 5000 ÷ 50 = **100 ml**
- **1 US gallon at 50:1** → 3785 ÷ 50 = **≈ 76 ml** (about 2.6 fl oz)

## Quick mixing chart (oil per amount of petrol)

| Ratio | Per 1 litre | Per 5 litres | Per 1 US gallon |
| --- | --- | --- | --- |
| **50:1** | 20 ml | 100 ml | ≈ 2.6 fl oz |
| **40:1** | 25 ml | 125 ml | ≈ 3.2 fl oz |
| **32:1** | 31 ml | 156 ml | ≈ 4.0 fl oz |
| **25:1** | 40 ml | 200 ml | ≈ 5.1 fl oz |
| **16:1** | 63 ml | 313 ml | ≈ 8.0 fl oz |

## A worked example, start to finish

Say your chainsaw manual specifies **50:1** and you want to fill a 2-litre fuel can:

1. Convert the fuel to millilitres: 2 litres = 2000 ml.
...
- When a range or "up to" is given, the richer (more oil) end suits heavy, hot or wide-open-throttle running.

Getting it wrong is expensive: too little oil is the fast route to a seized piston, while far too much causes heavy smoke, plug fouling and carbon build-up.
