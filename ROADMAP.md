...
**All 24 categories live** (~614 pages, 505+ tools):
...
| Home & DIY | **5 tools** — paint (wall area − openings × coats ÷ coverage), tile & flooring (area ÷ tile + waste %, boxes), concrete (L×W×thickness → m³/yd³ + pre-mix bags), mulch & soil (area × depth → m³/yd³/litres/bags), wallpaper (rolls from drops + pattern repeat) — metric or imperial, browser-verified |
