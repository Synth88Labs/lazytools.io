...
**All 33 categories live** (~716 pages, 590+ tools):
...
| Astronomy & Space | **8 tools** — moon phase (synodic month 29.530588853d anchored to Meeus Lunation-0 JD 2451550.09766 → phase/illumination/age), sunrise & sunset (NOAA solar-position algorithm via Julian Century, 90.833° zenith, ±1 min, verified vs NOAA for NYC), weight on other planets (Earth wt × NASA surface-gravity ratio; Pluto corrected to 0.071 per current NASA), age on other planets (Earth yr ÷ NASA sidereal orbital period), light travel time (÷ c=299,792.458 km/s; km↔AU↔ly↔parsec, IAU-exact units), angular size (θ=2·arctan(d/2D), small-angle 206,265×), telescope optics (mag=FL/ep, f-ratio, exit pupil, Dawes 116/D-mm, Rayleigh 138/D-mm, max-useful≈2×D-mm), stellar parallax (dist-pc=1/parallax-arcsec, ×3.26156=ly) — all constants research-verified vs NASA/NOAA/IAU, Node-tested (23 assertions) |
