...
- [opportunity] PDF redaction suite: rasterizing redactor + redaction checker — 2026-07-07, 20/25 — Epstein-files redaction fail (Dec 2025) + 65%-leak study; incumbents upload; checker half is the low-competition wedge
...
- [watchlist] WhatsApp chat export viewer (.txt/.zip, client-side) — 2026-07-07, 16/25 (wachatviewer.com already client-side; demand-pain evidence thin; promote with forum pain threads)
