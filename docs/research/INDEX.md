...
- [opportunity] PDF accessibility quick-checker (EAA, client-side pdf.js structure-tree) — 2026-07-07, 21/25 — no client-side incumbent found; PAC Windows-only, axesCheck uploads; EAA transition runs to June 2030
